...
<head>
	...
	<title>Affichage de fournisseurs</title>
</head>
<body>
	<h1>Affichage de fournisseurs</h1>
	...
	<?php
		...
		$query = $bdd->query("SELECT * FROM TIB_FOURNISSEURS");
		...
		if($query)
		{
			echo "<table border='1'><tr><th>Identifiant</th><th>Nom</th><th>Adresse</th>
				...
				<th>Adresse mail</th><th>Adresse internet</th><th>Modification</th>
				<th>Suppression</th>";
			...
			while($data = $query->fetch(PDO::FETCH_ASSOC))
			{
				...
				if(isset($_SESSION['connecte']) and $_SESSION['connecte'] === 1)
				{
					...
					echo "<td><a href='supprimer.php?idFournisseur=" . $data['idFournisseur'] .
						"'>Supprimer</a>";
				}
